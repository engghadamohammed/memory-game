...
function MemoryGame ()
{
    ...
    function flipImage ( image, index )
    {
        ...
        return (
            <div >
                <h2 className="text-center title ">Memory Game</h2>
   
<div class="container">
 
  <div class="row">
    <div class="col-8 points"><h3>Points: {points}</h3> </div>
    <div class="col-4"><button type="button" className="btn  "  onClick={startOver}>New Game</button></div>
  </div>
</div>   
                ...
                <div className="row no-gutters ">
                    {imagesArray?.map( ( image, index ) =>
                    {
                        return (
                            ...
                            <div className="col-2 col-lg-2 m-1" key={index} onClick={() => flipImage( image, index )}>
                                <img src={isCardChosen( image, index ) ? image : BLANK_CARD} alt="" className={`img-fluid img-fixed rounded-sm`} />
                            </div>
